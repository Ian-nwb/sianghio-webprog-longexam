...
const HomePage = () => {
        ...
        <div className="flex w-full flex-col gap-6">
            ...
            <section className="border-y-2 border-blue-900 bg-blue-900 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
                <div className="mb-6">
                    ...
                    <h2 className="mt-2 text-2xl font-semibold text-blue-900">Quick shopping blocks</h2>
                </div>
            ...
            <section className="border-y-2 border-blue-900 bg-blue-900 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
                <div className="mb-6">
                    ...
                    <h2 className="mt-2 text-2xl font-semibold text-blue-900">Simple store cards</h2>
                </div>

                <div className="grid gap-4 md:grid-cols-3">
                 <article className="rounded-3xl border-2 border-blue-900 bg-blue-50 p-4">
                <div className="mb-4 flex aspect-4/3 items-center justify-center overflow-hidden rounded-[1.25rem] bg-blue-200 border-2 border-blue-900">
                <img
                src={tote}
  ...
  <h3 className="text-lg font-semibold text-blue-900">Daily Essentials</h3>
  ...
  <Button to="/products" className="mt-4" variant="primary">View Products</Button>
                ...
                />
                        ...
                        <h3 className="mt-4 text-lg font-semibold text-blue-900">Study Supplies</h3>
                        <p className="mt-3 text-sm leading-6 text-blue-600">
                ...
                />
                        ...
                        <h3 className="mt-4 text-lg font-semibold text-blue-900">Campus Apparel</h3>
                        <p className="mt-3 text-sm leading-6 text-blue-600">
